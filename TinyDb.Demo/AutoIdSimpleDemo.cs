...
public static class AutoIdSimpleDemo
{
    public static Task RunAsync()
    {
        ...
        using var engine = new TinyDbEngine(demoDbPath);
    ...
    private static void DemonstrateAutoIntId(TinyDbEngine engine)
    {
    ...
    private static void DemonstrateAutoLongId(TinyDbEngine engine)
    {
    ...
    private static void DemonstrateAutoGuidId(TinyDbEngine engine)
    {
    ...
    private static void DemonstrateAutoStringId(TinyDbEngine engine)
    {
