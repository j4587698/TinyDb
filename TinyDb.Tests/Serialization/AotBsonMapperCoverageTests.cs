...
{
    // A type generated by Source Generator (AOT-only)
    [Entity]
    ...
    public async Task ConvertPrimitiveValue_Coverage()
    {
        ...
        // Enum
        await Assert.That(AotBsonMapper.ConvertEnumValue<DayOfWeek>(new BsonString("Monday"))).IsEqualTo(DayOfWeek.Monday);
