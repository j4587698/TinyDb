...
public class DataPageAccessExtendedTests : IDisposable
{
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("empty_col");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("multi_page");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("cache_test");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("read_at_test");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("invalid_idx");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("projection_test");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("large_doc_test");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("multi_large");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("compact_test");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("update_rewrite");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("empty_doc");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("complex_types");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("many_small");
    ...
    public async Task DataPageAccess_PersistAcrossReopen()
    {
        ...
        try
        {
            ...
            {
                var col = engine.GetCollectionWithName<BsonDocument>("persist_col");
                for (int i = 0; i < 10; i++)
                {
                    col.Insert(new BsonDocument().Set("_id", i).Set("name", $"doc_{i}"));
                }
...
public class DataPageAccessBoundaryTests : IDisposable
{
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("boundary_test");
        col.Insert(new BsonDocument().Set("_id", 1));
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("del_boundary");
        col.Insert(new BsonDocument().Set("_id", 1));
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("upd_boundary");
        col.Insert(new BsonDocument().Set("_id", 1));
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("dup_test");
        col.Insert(new BsonDocument().Set("_id", 1));
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("ins_del_all");
    ...
    {
        var col = _engine.GetCollectionWithName<BsonDocument>("iud_sequence");
