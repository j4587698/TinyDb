...
public class QueryProviderCoverageTests : IDisposable
{
    ...
    public async Task QueryProvider_CreateQuery_ShouldCreateQueryable()
    {
        ...
        await Assert.That(newQObj).IsTypeOf<UntypedQueryable<TestEntity>>();
    }
    ...
    public async Task QueryProvider_CreateQuery_WithInvalidCollection_ShouldThrow()
    {
        ...
        await Assert.That(() => new QueryProvider<TestEntity, TestEntity>(executor, null!)).Throws<ArgumentNullException>();
    }
