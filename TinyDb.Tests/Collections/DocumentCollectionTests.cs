...
public class DocumentCollectionTests : IDisposable
{
    ...
    {
        var collection = _engine.GetCollection<Item>();
        var item = new Item { Id = 1, Name = "New" };
    ...
    {
        var collection = _engine.GetCollection<Item>();
        collection.Insert(new Item { Id = 1, Name = "A" });
        collection.Insert(new Item { Id = 2, Name = "A" });
        collection.Insert(new Item { Id = 3, Name = "B" });
    ...
    {
        var collection = _engine.GetCollection<Item>();
        collection.Insert(new Item { Id = 1, Name = "Target" });
